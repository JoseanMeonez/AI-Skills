    ...
    tools: [
      {
        ...
        execute: async ({ skill_name }) => {
          ...
          // Format output similar to the AI CLI (e.g., Gemini CLI / Claude Code)'s Skill tool
...
When a skill references a the AI CLI (e.g., Gemini CLI / Claude Code) tool you don't have:
