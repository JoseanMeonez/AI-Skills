...
This plugin is included in the the AI CLI (e.g., Gemini CLI / Claude Code) repository. The command is automatically available when using the AI CLI (e.g., Gemini CLI / Claude Code).
