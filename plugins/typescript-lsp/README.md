...
TypeScript/JavaScript language server for the AI CLI (e.g., Gemini CLI / Claude Code), providing code intelligence features like go-to-definition, find references, and error checking.
