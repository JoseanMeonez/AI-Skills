...
### Using the AI assistant Marketplace (the AI CLI (e.g., Gemini CLI / Claude Code))

Install directly in the AI CLI (e.g., Gemini CLI / Claude Code) with two commands:
...
uipro init --ai the AI assistant      # the AI CLI (e.g., Gemini CLI / Claude Code)
...
**Supported:** the AI CLI (e.g., Gemini CLI / Claude Code), Cursor, Windsurf, Antigravity, Codex CLI, Continue, Gemini CLI, OpenCode, Qoder, CodeBuddy, Droid (Factory)
...
.claude/                     # Local dev/test for the AI CLI (e.g., Gemini CLI / Claude Code) skill
...
node dist/index.js init --ai the AI assistant --offline  # Test in a temp folder
